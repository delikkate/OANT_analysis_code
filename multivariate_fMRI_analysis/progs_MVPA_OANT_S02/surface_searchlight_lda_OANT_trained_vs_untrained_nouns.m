...
% data from S02 investigating the effects of NOUN training.
...
function surface_searchlight_lda_OANT_trained_vs_untrained_nouns(subNum, hemisphere)
...
lda_results.sa.labels={sprintf('Subject SUB%02d: untrained vs. trained nouns', subNum)};

%% save the resulting accuracy map as an .smp
data_output_fn = sprintf('SUB%02d_trained_vs_untrained_nouns_accuracy_map_%s.smp', subNum, hemisphere);
