...
% example call:
% create_singleStudyGLM_for_run_S01(1,1,1,'LH')
% create_singleStudyGLM_for_run_S01(1,1,1,'RH')

function run_surface_singleStudyGLM_for_run_S01(subNum, runNum, sesNum, hemisphere)
...
pathToSDM = [pathToGroupdata sprintf('%s_%02d_S%02d_OANT_onlyS01.sdm', subID, runNum, sesNum)];
