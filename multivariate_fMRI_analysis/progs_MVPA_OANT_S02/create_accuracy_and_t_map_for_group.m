...
pathToData = ['G:\Analysis_OANT\progs_MVPA_OANT_S02\' sprintf('searchlight_%s\\', hemisphere) map_name '\'];
...
% smp_group.Map.ShowPositiveNegativeFlag = 1; % 1 -> pos, 2 -> neg, 3 -> both  CHANGING THIS SETTING DOESN'T WORK (always both tails are displayed)
...
% % save the map
smp_accuracy_name = ['G:\Analysis_OANT\progs_MVPA_OANT_S02\group_decoding_maps\mean_accuracy\'...
...
% save the map
smp_tstat_name = ['G:\Analysis_OANT\progs_MVPA_OANT_S02\group_decoding_maps\uncorrected_t_maps\'...
