...
newPathToLog = [pwd sprintf('\\log_S01\\SUB%02d_RUN%02d_S%02d_OANT.mat', subject, runNum, sesNum)];
load(newPathToLog);
...
prt.name=[pwd sprintf('\\log_S01\\SUB%02d_RUN%02d_S%02d_OANT.prt', subject, runNum, sesNum)];
